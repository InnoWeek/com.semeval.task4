...
public final class TwoLayerGravesLstmNetworkTrainer extends AbstractNetworkTrainer {
    private TwoLayerGravesLstmNetworkTrainer(Path trainSet, Path testSet, WordVectors wordVectors, int vectorSize) {
        super(trainSet, testSet, wordVectors, vectorSize);
    }

    @Override
    protected MultiLayerNetwork createNetwork() {
        int nOut = Math.min(vectorSize, 200);
    ...
    public static void main(String[] args) throws TrainingException, IOException {
        ...
        final TwoLayerGravesLstmNetworkTrainer trainer = new TwoLayerGravesLstmNetworkTrainer(trainSet, testSet, wordVectors, vectorSize);
